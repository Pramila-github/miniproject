...
def main():
   ...
   if nav == "Home 🏡":
    ...
    st.markdown("<h1 style=' color:orange; text_align:center;font-weight: bold;font-size:19pt;'>Made by Quad Techies with ❤️</h1>", unsafe_allow_html=True)
    st.markdown("<h1 style ='color:dark-green; text_align:center;font-family:times new roman;font-weight: bold;font-size:20pt;'>WIND POWER PREDICTION DL WEB-APP</h1>", unsafe_allow_html=True)
