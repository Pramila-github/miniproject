    ...
    with st.beta_expander("Write a review 📝"):
        ...
        if st.button("Post ✔️"):
		    ...
		    #st.markdown("<h1 style='text-align: center; color:black ;background-color:powderblue;font-size:14pt'> {} </h1>".format(username), unsafe_allow_html=True)
                    st.markdown("<h1 style='text-align: center; color:DeepPink;background-color:white;font-size:12pt;border-style: solid;border-color:Deeppink;border-radius:5px'> Thankyou for your comment {} - with regards Team DeepWind❤️🎉 </h1>".format(username),unsafe_allow_html=True)
