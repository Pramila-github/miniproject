...
def main():
   ...
   if nav == "Home 🏡":
    ...
    st.markdown("<h1 style ='color:green; text_align:center;font-family:times new roman;font-weight: bold;background-color:white;font-size:18pt;'>WIND POWER PREDICTION DL WEB-APP</h1>", unsafe_allow_html=True)
