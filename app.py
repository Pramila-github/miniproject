...
def main():
   ...
   if nav == "Home 🏡":
    st.markdown("<h1 style ='color:white; text_align:center;font-family:times new roman;font-size:20pt; font-weight: bold;'>DEEP WINDS ⚒️</h1>", unsafe_allow_html=True)
    st.markdown("<h1 style=' color:#BB1D3F; text_align:center;font-weight: bold;font-size:19pt;background-color:white'>Made by Quad Techies with ❤️</h1>", unsafe_allow_html=True)
