...
def main():
   ...
   if nav == "Home 🏡":
    ...
    st.markdown("<h1 style ='color:green; text_align:center;font-family:times new roman;font-weight: bold;font-size:30pt;'>WIND POWER PREDICTION DL WEB-APP</h1>", unsafe_allow_html=True)
