...
def main():
   ...
   if nav == "Home 🏡":
    st.markdown("<h1 style ='color:white; text_align:center;font-family:times new roman;background-color:blue;font-size:20pt; font-weight: bold;'>DEEP WINDS ⚒️</h1>", unsafe_allow_html=True)
