...
try:
    ...
    # set bg
    set_png_as_page_bg('WindmillWallpaper_martanda[1].jpg')
...
# Setup file upload
    ...
    yaxis = {'title' : "Power generated by system | (kW)"}
       ...
       st.write("\n")
       st.write("---------------------------📈 INPUT DATA IN TERMS OF NO. OF HOURS 📈 --------------------------")
...
# demonstrate prediction for next 10 days
  ...
  #plt.plot(day_new,scaler.inverse_transform(df1[len(df1)-30:]))
       st.write("-------------------------📈 PREDICTED RESULTS FOR NEXT 24 HOURS 📈--------------------------")
...
# Set the y axis label of the current axis.
       ...
       st.pyplot(plt)
       st.write("🏷️ G-Given Data, \n🏷️T-Train Data, \n🏷️T-Test Data, \n🏷️P-Predicted Results")
