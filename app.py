...
def main():
   ...
   if nav == "Home 🏡":
    ...
    st.markdown("<h1 style ='color:	blue; text_align:center;font-family:times new roman;font-weight: bold;font-size:18pt;'>WIND POWER PREDICTION DL WEB-APP</h1>", unsafe_allow_html=True)
