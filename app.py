...
def main():
   ...
   if nav == "Home 🏡":
   # set_png_as_page_bg(r'C:\Users\PRAMILA\Documents\electric-fan.gif')
    st.markdown("<h1 style ='color:black; text_align:center;font-family:times new roman;font-size:32pt; font-weight: bold;'>DEEP WINDS ⚒️</h1>", unsafe_allow_html=True)
