...
def main():
   ...
   if nav == "Home 🏡":
    st.markdown("<h1 style ='color:black; text_align:center;font-family:times new roman;background-color:black;font-color:white;font-size:20pt; font-weight: bold;'>DEEP WINDS ⚒️</h1>", unsafe_allow_html=True)
